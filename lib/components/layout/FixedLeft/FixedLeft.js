...
var FixedLeft = function (_React$Component) {
  ...
  function FixedLeft() {
    ...
    var _this = _possibleConstructorReturn(this, (FixedLeft.__proto__ || Object.getPrototypeOf(FixedLeft)).call(this));

    _this.handleScroll = function () {
      if (_this.props.stickAt) {
        var offsetViewport = _this.fixed.offsetTop;
        var offsetDoc = getOffsetTop(_this.fixed);
        var ty = (0, _lodash.clamp)(offsetDoc - offsetViewport, 0, _this.fixedViewportOffsetOrigin - (_this.props.stickAt || 0));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: _style2.default.content, style: _extends({}, this.props.contentStyle) },
            children[1]
          )
        )
      );
...
module.exports = {"clearfix":"src-components-layout-FixedLeft-clearfix__3998L","wrapper":"src-components-layout-FixedLeft-wrapper__156Sv","fixedWrapper":"src-components-layout-FixedLeft-fixedWrapper__2wyeB","contentWrapper":"src-components-layout-FixedLeft-contentWrapper__3BCtj","stub":"src-components-layout-FixedLeft-stub__lvre9","content":"src-components-layout-FixedLeft-content__1TpN6"};
