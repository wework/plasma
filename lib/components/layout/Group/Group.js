      ...
      var Group = (function(_React$Component) {
        ...
        function Group() {
          ...
          return _possibleConstructorReturn(
            this,
            (Group.__proto__ || Object.getPrototypeOf(Group)).apply(this, arguments)
          );
        }
        ...
        _createClass(Group, [
          {
            ...
            value: function render() {
              ...
              var groupStyle = (0, _classnames2.default)(
                _style2.default.wrapper,
                _defineProperty({}, _style2.default.vertical, this.props.vertical)
              );

              var children = this.props.children;
              if (!(0, _lodash.isArray)(this.props.children)) {
                children = (0, _lodash.toArray)(this.props.children);
              }
              ...
              return _react2.default.createElement(
                ...
                (0, _lodash.map)(children, function(child, index) {
                  var styleObj = {};
                  if (_this2.props.layout[index] === 'shrink') {
                    styleObj.flexShrink = '1';
                  } else if (_this2.props.layout[index] === 'grow') {
                    styleObj.flexGrow = '1';
                  } else if (_this2.props.layout[index]) {
                    styleObj.flexBasis = _this2.props.layout[index];
                  } else {
                    styleObj.flexBasis =
                      100 / _react2.default.Children.count(_this2.props.children) + '%';
                  }
