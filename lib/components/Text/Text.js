        ...
        _createClass(Text, [
          {
            ...
            value: function render() {
              ...
              var textStyle = (0, _classnames2.default)(
                _style2.default.wrapper,
                ((_cx = {}),
                _defineProperty(_cx, _style2.default.large, large),
                _defineProperty(_cx, _style2.default.primary, type === types.PRIMARY),
                _defineProperty(_cx, _style2.default.secondary, type === types.SECONDARY),
                _cx)
              );
