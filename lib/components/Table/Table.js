      ...
      var Table = (function(_React$Component) {
        ...
        function Table() {
          ...
          var _this = _possibleConstructorReturn(
            this,
            (Table.__proto__ || Object.getPrototypeOf(Table)).call(this)
          );
          ...
          _this.handleScroll = function() {
            ...
            if (stickAt != null) {
              ...
              var bottomAtOrAboveStickyPoint =
                tableBottomOffset - _this.state.headerHeight < stickAt;
              var isVisible = false;
          ...
          _this.updateState = function(newState, callback) {
            ...
            if (
              !(0, _lodash.isEqual)(
                (0, _lodash.pick)(_this.state, (0, _lodash.keys)(newState)),
                newState
              )
            ) {
          ...
          },
          {
            ...
            value: function renderCarat() {
              ...
              return _react2.default.createElement(_Icon2.default, {
                color: '#fff',
                icon: sort && sort.order === 'asc' ? _downArrow2.default : _upArrow2.default,
              });
            },
          },
          {
            ...
            value: function renderHeader() {
              ...
              var headerComponents = (0, _lodash.map)(this.props.headerData, function(value) {
                ...
                var cellStyle = (0, _classnames2.default)(
                  _style2.default.cell,
                  _defineProperty({}, _style2.default.sortableColumn, value.sortable)
                );
                return _react2.default.createElement(
                  'th',
                  {
                    className: (0, _classnames2.default)(
                      ((_cx2 = {}),
                      _defineProperty(_cx2, cellStyle, true),
                      _defineProperty(_cx2, _style2.default.condensedCell, value.condensed),
                      _cx2)
                    ),
                    style: colStyles,
                    key: key,
                  ...
                  value.sortable &&
                    _react2.default.createElement('div', {
                      className: (0, _classnames2.default)(
                        _style2.default.sortableColumnHighlight,
                        _defineProperty(
                          {},
                          _style2.default.sortableColumnHighlightSelected,
                          _this3.props.selectedColumnKey === key
                        )
                      ),
                    })
                );
                  ...
                  columnComponents.push(
                    _react2.default.createElement(
                      'td',
                      {
                        className: (0, _classnames2.default)(
                          _style2.default.cell,
                          _defineProperty({}, _style2.default.condensedCell, isCondensed)
                        ),
                        key: headerKey,
                        rowSpan: rowsToSpan,
                      },
                ...
                rowComponents.push(
                  _react2.default.createElement(
                    'tr',
                    {
                      ...
                      className: (0, _classnames2.default)(
                        _style2.default.row,
                        itemValue.rowClassName,
                        ((_cx5 = {}),
                        _defineProperty(_cx5, _style2.default.rowDisabled, isDisabledRow),
                        _defineProperty(_cx5, _style2.default.clickable, clickable),
                        _defineProperty(_cx5, _style2.default.highlightable, highlightable),
                        _cx5)
                      ),
                    },
                    columnComponents
                      ...
                      _react2.default.createElement(
                        'tr',
                        {
                          ...
                          className: (0, _classnames2.default)(
                            ...
                            itemValue.rowClassName,
                            ((_cx6 = {}),
                            _defineProperty(_cx6, _style2.default.rowDisabled, isDisabledRow),
                            _defineProperty(_cx6, _style2.default.clickable, clickable),
                            _defineProperty(_cx6, _style2.default.highlightable, highlightable),
                            _cx6)
                          ),
                        },
                        partialRowColumns
                ...
                this.props.stickAt != null &&
                  _react2.default.createElement(
                    'div',
                    {
                      ...
                      className: (0, _classnames2.default)(
                        _style2.default.table,
                        _style2.default.sticky
                      ),
                      style: {
