  ...
  _createClass(Toggle, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'ul',
        _extends({}, (0, _dataUtils.getDataAttrs)(this.props.data), { className: _style2.default.toggleWrapper, role: 'tablist' }),
        _lodash2.default.map(this.props.items, function (item, index) {
          var _cx;

          var isActive = _this2.props.selectedIndex === index || _this2.props.selectedLabel === item.label;
          var toggleClasses = (0, _classnames2.default)(_style2.default.toggle, _this2.props.className, (_cx = {}, _defineProperty(_cx, _style2.default.active, isActive), _defineProperty(_cx, _style2.default.disabled, item.disabled), _defineProperty(_cx, _style2.default.horizontal, _this2.props.type === type.HORIZONTAL), _defineProperty(_cx, _style2.default.vertical, _this2.props.type === type.VERTICAL), _defineProperty(_cx, _style2.default.small, _this2.props.size === type.SMALL), _cx));
...
module.exports = {"toggle":"src-components-Toggle-toggle__QQ3Oi","clearfix":"src-components-Toggle-clearfix__1h5vE","toggleWrapper":"src-components-Toggle-toggleWrapper__1rWLv","small":"src-components-Toggle-small__3ENgU","horizontal":"src-components-Toggle-horizontal__3e6ds","active":"src-components-Toggle-active__1qXnY","vertical":"src-components-Toggle-vertical__3sHwb","disabled":"src-components-Toggle-disabled__1iJdD"};
