        ...
        function OverflowMenu() {
          ...
          return (
            (_ret = ((_temp = ((_this = _possibleConstructorReturn(
              this,
              (_ref = OverflowMenu.__proto__ || Object.getPrototypeOf(OverflowMenu)).call.apply(
                _ref,
                [this].concat(args)
              )
            )),
        ...
        _createClass(OverflowMenu, [
          {
            ...
            value: function render() {
              ...
              var revealableStyle = (0, _classnames2.default)(
                _style2.default.revealable,
                _defineProperty({}, _style2.default.revealed, this.state.revealed)
              );
              var revealableListStyle = (0, _classnames2.default)(
                _style2.default.revealableList,
                _defineProperty(
                  {},
                  _style2.default.openLeft,
