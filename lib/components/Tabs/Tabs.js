          ...
          return (
            ...
            (_this.getTabClassNames = function(tab, index) {
              ...
              return (0, _classnames2.default)(
                ...
                _defineProperty(
                  _cn,
                  _style2.default.active,
                  _this.props.selectedIndex === index || _this.props.selectedLabel === tab.label
                ),
                _defineProperty(_cn, _style2.default.first, index === 0),
                _defineProperty(_cn, _style2.default.last, index === _this.props.items.length - 1),
                _cn)
              );
            }),
