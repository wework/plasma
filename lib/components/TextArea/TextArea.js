        ...
        function TextArea() {
          ...
          return (
            (_ret = ((_temp = ((_this = _possibleConstructorReturn(
              this,
              (_ref = TextArea.__proto__ || Object.getPrototypeOf(TextArea)).call.apply(
                _ref,
                [this].concat(args)
              )
            )),
          ...
          },
          {
            ...
            value: function render() {
              ...
              var wrapperStyle = (0, _classnames2.default)(
                ...
                _defineProperty(
                  _cx,
                  _style2.default.wrapperLarge,
                  (0, _lodash.toUpper)(size) === 'LARGE'
                ),
                _cx)
              );

              var textareaStyle = (0, _classnames2.default)(
                _style2.default.textarea,
                ((_cx2 = {}),
                _defineProperty(_cx2, _style2.default.disabled, disabled),
                _defineProperty(
                  _cx2,
                  _style2.default.large,
                  (0, _lodash.toUpper)(size) === 'LARGE'
                ),
                _cx2)
              );
