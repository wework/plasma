...
var SegmentedCard = function (_React$Component) {
  ...
  function SegmentedCard() {
    ...
    return _possibleConstructorReturn(this, (SegmentedCard.__proto__ || Object.getPrototypeOf(SegmentedCard)).apply(this, arguments));
  }

  _createClass(SegmentedCard, [{
    key: 'render',
    value: function render() {
      var className = (0, _classnames2.default)(_style2.default.card, _defineProperty({}, _style2.default.vertical, this.props.vertical));
      var children = _react2.default.Children.toArray(this.props.children);

      return _react2.default.createElement(
        'div',
        _extends({}, (0, _dataUtils.getDataAttrs)(this.props.data), { className: className, style: this.props.style }),
...
module.exports = {"clearfix":"src-components-SegmentedCard-clearfix__1I4fS","card":"src-components-SegmentedCard-card__3q4W_","vertical":"src-components-SegmentedCard-vertical__3znGg","first":"src-components-SegmentedCard-first__2qcN4","second":"src-components-SegmentedCard-second__23cOX"};
