        ...
        function SideBarNavTop() {
          ...
          return (
            (_ret = ((_temp = ((_this = _possibleConstructorReturn(
              this,
              (_ref = SideBarNavTop.__proto__ || Object.getPrototypeOf(SideBarNavTop)).call.apply(
                _ref,
                [this].concat(args)
              )
            )),
            _this)),
            (_this.input = _this.props.forwardedRef || _react2.default.createRef()),
            _temp)),
              ...
              return _react2.default.createElement(
                'div',
                {
                  className: (0, _classnames2.default)(
                    className,
                    _style2.default.top,
                    _defineProperty({}, _style2.default.fullWidth, fullWidth)
                  ),
                  onClick: onClick,
                },
      ...
      var SideNavBar = (function(_Component) {
        ...
        function SideNavBar() {
          ...
          return (
            (_ret = ((_temp = ((_this = _possibleConstructorReturn(
              this,
              (_ref = SideNavBar.__proto__ || Object.getPrototypeOf(SideNavBar)).call.apply(
                _ref,
                [this].concat(args)
              )
            )),
            _this)),
            (_this.handleClick = function(result) {
          ...
          },
          {
            ...
            value: function render() {
              ...
              return _react2.default.createElement(
                ...
                (topText || topIcon) &&
                  _react2.default.createElement(_SideNavBarTop2.default, {
                    label: topText,
                    icon: topIcon,
                    onClick: onClickTop,
                    onBlur: onBlurTop,
      ...
      var SideNavBarItem = (function(_Component) {
        ...
        function SideNavBarItem() {
          ...
          return (
            (_ret = ((_temp = ((_this = _possibleConstructorReturn(
              this,
              (_ref = SideNavBarItem.__proto__ || Object.getPrototypeOf(SideNavBarItem)).call.apply(
                _ref,
                [this].concat(args)
              )
            )),
        ...
        _createClass(SideNavBarItem, [
          {
            ...
            value: function renderIconAndLabel() {
              ...
              return _react2.default.createElement(
                'div',
                { className: _style2.default.iconAndLabelContainer },
                _react2.default.createElement('div', { className: _style2.default.label }, label)
              );
            },
          },
          {
            ...
            value: function render() {
              ...
              var wrapperClasses = (0, _classnames2.default)(
                _style2.default.itemWrapper,
                ((_cn = {}),
                _defineProperty(_cn, _style2.default.darkBg, darkBg),
                _defineProperty(_cn, _style2.default.selected, selected),
                _cn)
              );
        ...
        function SideNavBarItemGroup() {
          ...
          return (
            (_ret = ((_temp = ((_this = _possibleConstructorReturn(
              this,
              (_ref =
                SideNavBarItemGroup.__proto__ ||
                Object.getPrototypeOf(SideNavBarItemGroup)).call.apply(_ref, [this].concat(args))
            )),
            _this)),
            (_this.handleGroupClick = function() {
        ...
        _createClass(SideNavBarItemGroup, [
          {
            ...
            value: function renderIconAndLabel() {
              ...
              if (
                !(0, _lodash.find)(items, function(item) {
                  return !item.hidden;
                })
              ) {
                return null;
          ...
          },
          {
            ...
            value: function renderSubItems() {
              ...
              return (
                this.props.items &&
                this.props.items.map(function(groupedItem) {
                  return (
                    !groupedItem.hidden &&
                    _react2.default.createElement(_SideNavBarItem2.default, {
                      key: groupedItem.id,
                      id: groupedItem.id,
