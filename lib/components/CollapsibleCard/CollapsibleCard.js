...
var CollapsibleCard = function (_Component) {
  ...
  function CollapsibleCard() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CollapsibleCard.__proto__ || Object.getPrototypeOf(CollapsibleCard)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      shouldDisplayCard: !_this.props.isCollapsed
    }, _this.onClick = function () {
      _this.setState(function (prevState) {
        return { shouldDisplayCard: !prevState.shouldDisplayCard };
      });
  ...
  _createClass(CollapsibleCard, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          collapsibleText = _props.collapsibleText,
          children = _props.children,
          styleColor = _props.styleColor,
          disabled = _props.disabled;
      var shouldDisplayCard = this.state.shouldDisplayCard;


      var collapsibleCardStyle = (0, _classnames2.default)(_style2.default.collapsibleCard, _defineProperty({}, _style2.default.styleColorRed, styleColor === _Card.borderColors.RED));

      return _react2.default.createElement(
        'div',
        { className: collapsibleCardStyle },
        _react2.default.createElement(
          'div',
          ...
          !disabled && _react2.default.createElement(
            'div',
            { className: _style2.default.textLink, onClick: this.onClick },
            collapsibleText,
            _react2.default.createElement('div', {
              className: shouldDisplayCard ? _style2.default.textLinkArrowUp : _style2.default.textLinkArrowDown
            })
          )
        ),
        !disabled && shouldDisplayCard && _react2.default.createElement(
          _Card2.default,
...
// removed by extract-text-webpack-plugin
module.exports = {"clearfix":"src-components-CollapsibleCard-clearfix__F6p1f","collapsibleCard":"src-components-CollapsibleCard-collapsibleCard__32LcH","cardHeader":"src-components-CollapsibleCard-cardHeader__RObOz","textLink":"src-components-CollapsibleCard-textLink__105PP","textLinkArrowUp":"src-components-CollapsibleCard-textLinkArrowUp__2_TZf","textLinkArrowDown":"src-components-CollapsibleCard-textLinkArrowDown__RDKsF","styleColorRed":"src-components-CollapsibleCard-styleColorRed__1vmwl"};
