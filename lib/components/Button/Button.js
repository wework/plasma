    ...
    /***/ 58: /***/ function(module, exports, __webpack_require__) {
      ...
      function Button(props) {
        ...
        var classes = (0, _classnames2.default)(
          _style2.default.button,
          className,
          ((_cx = {}),
          _defineProperty(_cx, _style2.default.primary, type === Variants.PRIMARY),
          _defineProperty(_cx, _style2.default.secondary, type === Variants.SECONDARY),
          _defineProperty(_cx, _style2.default.tertiary, type === Variants.TERTIARY),
          _defineProperty(_cx, _style2.default.small, size === Sizes.SMALL),
          _defineProperty(_cx, _style2.default.loading, loading),
          _cx)
        );
        ...
        if (loading) {
          ...
          contentComponent = _react2.default.createElement(_Loader2.default, {
            dotStyle: loaderDotStyle,
          });
        } else {
