...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_create_emotion__ = __webpack_require__(37);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__emotion_memoize__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__emotion_unitless__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__emotion_hash__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__emotion_stylis__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_stylis_rule_sheet__ = __webpack_require__(42);
...
var isBefore = function isBefore(date, otherDate) {
  return date.getTime() < otherDate.getTime();
};
var isAfter = function isAfter(date, otherDate) {
  return date.getTime() > otherDate.getTime();
};
// using an arbitrary date as we only care about time
var get24HourTimeAsDate = function get24HourTimeAsDate(value) {
  return new Date('2018-01-01 ' + (value || '00:00'));
};

var enumerateOptions = function enumerateOptions(start, end, intervalMinutes, timeFormat) {
  var minTime = get24HourTimeAsDate(start);
  var maxTime = get24HourTimeAsDate(end);

  var timeValue = new Date(minTime);
  var options = [];
...
var ClockIcon = function ClockIcon() {
  return _react2.default.createElement('span', { className: _style2.default.selectClockIcon });
};
...
var TimePicker = function (_React$Component) {
  ...
  function TimePicker() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TimePicker.__proto__ || Object.getPrototypeOf(TimePicker)).call.apply(_ref, [this].concat(args))), _this), _this.getOptions = function () {
      return enumerateOptions(_this.props.minTime || TimePicker.defaultProps.minTime, _this.props.maxTime || TimePicker.defaultProps.maxTime, _this.props.timeIntervalMinutes || TimePicker.defaultProps.timeIntervalMinutes, _this.props.timeFormat);
  ...
  _createClass(TimePicker, [{
    ...
    value: function getValue(value) {
      ...
      var start = get24HourTimeAsDate(minTime);
      var end = get24HourTimeAsDate(maxTime);
      var valueAsDate = get24HourTimeAsDate(value);
    ...
    value: function defaultTimeSelected() {
      var _props2 = this.props,
          ...
          timeIntervalMinutes = _props2$timeIntervalM === undefined ? TimePicker.defaultProps.timeIntervalMinutes : _props2$timeIntervalM,
      ...
      switch (defaultOption) {
        case TimePicker.DefaultOptions.nextInterval:
          {
            var now = new Date();
            var roundedUp = Math.ceil(now.getMinutes() / timeIntervalMinutes) * timeIntervalMinutes;
    ...
    value: function render() {
      ...
      var _props3 = this.props,
          ...
          rest = _objectWithoutProperties(_props3, ['borderless', 'className', 'disabled', 'error', 'menuIsOpen', 'value', 'placeholder']);

      var timeSelectClassName = (0, _classnames2.default)(_style2.default.selectInput, className, (_cn = {}, _defineProperty(_cn, _style2.default.borderless, borderless), _defineProperty(_cn, _style2.default.selectInputError, error), _cn));

      var currentValue = this.getValue(value);
      var options = this.getOptions();
      var currentOption = options.find(function (item) {
        return item.value === currentValue;
      });

      var restProps = (0, _lodash.omit)(rest, 'defaultOption', 'hidden', 'maxTime', 'minTime', 'timeFormat', 'timeIntervalMinutes', 'title');

      return _react2.default.createElement(_reactSelect2.default, _extends({}, restProps, {
        menuIsOpen: menuIsOpen,
        components: {
...
module.exports = {"selectInput":"src-components-TimePicker-selectInput__EHUYe","clearfix":"src-components-TimePicker-clearfix__1C10P","selectInputError":"src-components-TimePicker-selectInputError__20UFU","selectClockIcon":"src-components-TimePicker-selectClockIcon__2JwN-","borderless":"src-components-TimePicker-borderless__2iBMQ"};
