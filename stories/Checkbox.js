...
storiesOf('Checkbox', module)
  ...
  .add('with description', () => <Checkbox description={'Hint: this is some text.'} />)
  .add('checked', () => <Checkbox checked />)
  .add('unchecked', () => <Checkbox checked={false} />)
  .add('indeterminate unchecked', () => <Checkbox indeterminate />)
  .add('indeterminate checked', () => <Checkbox indeterminate checked />)
  .add('icon', () => (
    <StoryState
