...
const Select = React.createClass({
  ...
  renderLoading () {
    ...
    return (
      <span className={ style.loadingZone } aria-hidden="true">
  ...
  renderValue (valueArray, isOpen) {
    ...
    if (!valueArray.length) {
      return !this.state.inputValue ? <div className={ style.placeholder }>{this.props.placeholder}</div> : null;
    }
    ...
    if (this.props.multi) {
      return valueArray.map((value, i) => {
        return (
          ...
          >
            {renderLabel(value)}
            <span className={ style.ariaOnly }>&nbsp;</span>
          </ValueComponent>
        );
      });
  ...
  renderInput (valueArray, focusedOptionIndex) {
    if (this.props.inputRenderer) {
      ...
      var className = classNames(style.input, this.props.inputProps.className);
  ...
  renderClear () {
    ...
    return (
      <span className={ style.clearZone } title={this.props.multi ? this.props.clearAllText : this.props.clearValueText}
      ...
      >
        <span className={ style.clear } dangerouslySetInnerHTML={{ __html: '&times;' }} />
      </span>
    );
  },
  ...
  renderArrow () {
    return (
      <span className={ style.arrowZone } onMouseDown={this.handleMouseDownOnArrow}>
        <span className={ style.arrow } onMouseDown={this.handleMouseDownOnArrow} />
      </span>
    );
  },
      ...
      if (this.props.menuRenderer) {
        ...
        return options.map((option, i) => {
          ...
          let optionClass = classNames(this.props.optionClassName, {
            ...
            [style.isDisabled]: option.disabled,
          });
  ...
  renderOuter (options, valueArray, focusedOption) {
    ...
    return (
      <div ref="menuContainer" className={ style.menuOuter } style={this.props.menuContainerStyle}>
        <div ref="menu" role="listbox" className={ style.menu } id={this._instancePrefix + '-list'}
  ...
  render () {
    ...
    let className = classNames(style.select, this.props.className, {
      [style.multi]: this.props.multi,
      [style.single]: !this.props.multi,
      [style.isDisabled]: this.props.disabled,
      [style.isFocused]: this.state.isFocused,
      [style.isLoading]: this.props.isLoading,
      [style.isOpen]: isOpen,
      [style.isPseudoFocused]: this.state.isPseudoFocused,
      [style.isSearchable]: this.props.searchable,
      [style.hasValue]: valueArray.length,
    });
    ...
    if (this.props.multi &&
      ...
      removeMessage = (
        <span id={this._instancePrefix + '-backspace-remove-message'} className={ style.ariaOnly } aria-live="assertive">
    ...
    return (
      <div ref="wrapper"
        ...
        <div ref="control"
          ...
          onTouchMove={this.handleTouchMove}
        >
          <span className={ style.multiValueWrapper } id={this._instancePrefix + '-value'}>
