...
function getSelectedNodes(selectedHierarchy) {
  return selectedHierarchy.reduce(function (nodes, namespace, index) {
    var node = {};

    node.type = selectedHierarchy.length - 1 === index ? _tree_node_type2.default.COMPONENT : _tree_node_type2.default.NAMESPACE;
    ...
    value: function mapStoriesHierarchy(storiesHierarchy) {
      ...
      if (storiesHierarchy.isNamespace) {
        ...
        if (storiesHierarchy.map.size > 0) {
          ...
          storiesHierarchy.map.forEach(function (childItems) {
            childItems.forEach(function (item) {
              treeModel.children.push(_this2.mapStoriesHierarchy(item));
            });
          });
        }
      } else {
        ...
        treeModel.type = _tree_node_type2.default.COMPONENT;

        treeModel.children = storiesHierarchy.stories.map(function (story) {
          return {
            name: story.name,
            story: story.name,
