...
var POSTPROCESS_MEMBERS = {
  propTypes: function propTypes(path) {
    return types.Function.check(path.node) ? (0, _resolveFunctionDefinitionToReturnValue2.default)(path) : path;
  }
};
