// flow-typed version: <<STUB>>/@wework-dev/plasma_v0.1.4/flow_v0.84.0
...
declare module '@wework-dev/plasma' {
  ...
  declare type TimeFormatType = 'HH:mm' | 'hh:mm A';
  ...
  // source file: src/components/TimePicker/TimePicker.jsx
  declare type DefaultOption = 'nextInterval' | 'minimum';
  ...
  declare type HandleEvent = {|
    nativeEvent: { target: { value: Object } },
  ...
  declare export class TextInput extends React$Component<{|
    ...
    name?: string,
    onBlur?: SyntheticFocusEventHandler<HTMLInputElement>,
    onChange?: SyntheticInputEventHandler<HTMLInputElement>,
    onClick?: SyntheticMouseEventHandler<HTMLInputElement>,
    onFocus?: SyntheticFocusEventHandler<HTMLInputElement>,
    placeholder?: string,
    prefix?: React$Node,
    suffix?: React$Node,
    tabIndex?: string | number,
